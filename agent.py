...
def convert_and_transfer(from_currency: str, to_currency: str, from_address: str, to_address: str, amount: float) -> str:
    ...
    try:
        ...
        # If none of the specific cases match, return an error
    ...
    try:
        ...
        if response_message.get("tool_calls"):
            ...
            for call in response_message["tool_calls"]:
                ...
                # Handle potentially empty arguments string
...
agent = Agent(name="financial_agent", seed="financial_agent_secret_phrase")
fund_agent_if_low(agent.wallet.address())
chat_proto = Protocol("FinancialTransactionChat", spec=chat_protocol_spec)

# Use the imported chat_protocol instance directly for handlers
...
# Include the verified protocol instance in the agent
# agent.include(chat_protocol_spec, publish_manifest=True)

# This standalone function is for local testing without running the full uAgent
